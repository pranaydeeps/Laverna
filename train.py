...
def main():
    ...
    #_________________TEMPORARY FIX HERE, HARD CODE MAX INPUT LEN_________________________________#
    ...
    print(token_probs.size(0))

    print(stu_architecture_config.vocab_size)
